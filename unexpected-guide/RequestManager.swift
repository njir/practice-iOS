...
class RequestManager {
    ...
    func searchArt(searchText: String) {
        let url: String = "http://localhost:3000/api/art?keyword=\(searchText)&" + pageString // TODO: add pageNumber
        print(url)
    ...
    func searchVoice(artId: Int) {
        let url: String = "http://localhost:3000/api/voice/art/\(artId)?" + pageString // TODO: add pageNumber
        print("voice:", url)
